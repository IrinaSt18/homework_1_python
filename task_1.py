...
### больше суммы двух других, то треугольника с такими сторонами не существует. Отдельно сообщить является ли треугольник 
### разносторонним, равнобедренным или равносторонним.

a = int(input("Введите a сторону треугольника: "))
b = int(input("Введите b сторону треугольника: "))
c = int(input("Введите c сторону треугольника: "))
